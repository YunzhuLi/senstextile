...
from data import make_dataset_for_glove_calibration_withscale_touch_only
...
for eval_path in eval_list:
    ...
    data
    '''
    touch_raw_rec, touch_rec, touch_ts_rec = make_dataset_for_glove_calibration_withscale_touch_only(
